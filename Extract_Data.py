...
def extract_data(filename_change, file_key, n_levels):
    ...
    #print("Загрузка изображения и извлечение данных...")
    ...
    length_of_symbol = length_of_symbol * 1.5 # 1.5 - это избыточность вносимая помехоустойчивым кодирование (код Хаффмана 8/12)
    ...
    #print("Извлеченное сообщение: ", real_message)
...
print("Извлеченное сообщение: [" + exctract_message + "]")
'''